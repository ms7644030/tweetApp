...
class TweetControllerTest {
	...
	void addTweetTest() throws Exception {
		...
		MvcResult result1 = mockMvc.perform(post("http://localhost:9001/api/v1.0/tweets/" + userName + "/add")
	...
	void getAllTweetsTest() throws Exception {
		MvcResult result1 = mockMvc.perform(get("http://localhost:9001/api/v1.0/tweets/all")).andReturn();
		String actual = result1.getResponse().getContentAsString();
	...
	void getUsersTweetsTest() throws Exception {
		String userName = "manish123";
		MvcResult result1 = mockMvc.perform(get("http://localhost:9001/api/v1.0/tweets/" + userName)).andReturn();
		String actual = result1.getResponse().getContentAsString();
		assertEquals(actual, actual);
	}
	...
	void updateTweetsTest() throws Exception {
		String userName = "manish123";
		when(usersService.getByUserName(userName)).thenReturn(null);
		MvcResult result1 = mockMvc.perform(put(
				"http://localhost:9001/api/v1.0/tweets/" + userName + "/update/a1331033-f4ac-496a-9092-79366d960750")
				.sessionAttr("userName", userName).contentType(MediaType.APPLICATION_JSON)
				.content("{\"tweetText\":\"welcome\"}").accept(MediaType.APPLICATION_JSON)).andReturn();
		String actual = result1.getResponse().getContentAsString();
		String expected = "User name not found";
	...
	void updateTweetsIdNotFoundTest() throws Exception {
		...
		MvcResult result1 = mockMvc
				.perform(put("http://localhost:9001/api/v1.0/tweets/" + userName + "/update/90798d7f-f4e6-4ace-b2ee")
						.sessionAttr("userName", userName).contentType(MediaType.APPLICATION_JSON)
						.content("{\"tweetText\":\"welcome\"}").accept(MediaType.APPLICATION_JSON))
				.andReturn();
		String actual = result1.getResponse().getContentAsString();
	...
	void deleteTweetTest() throws Exception {
		String userName = "manish123";
		MvcResult result1 = mockMvc
				.perform(delete("http://localhost:9001/api/v1.0/tweets/" + userName
						+ "/delete/a1331033-f4ac-496a-9092-79366d960750").sessionAttr("userName", userName))
				.andReturn();
		String actual = result1.getResponse().getContentAsString();
	...
	void deleteTweetNotFoundTest() throws Exception {
		...
		MvcResult result1 = mockMvc
				.perform(delete("http://localhost:9001/api/v1.0/tweets/" + userName
						+ "/delete/c20b1bc8-02cc-4586-a55a-5adcd178c4f5").sessionAttr("userName", userName))
				.andReturn();
		String actual = result1.getResponse().getContentAsString();
		String expected = "Given tweetId cannot be found";
		assertEquals(expected, actual);
	...
	void likeTweetTest() throws Exception {
		...
		MvcResult result1 = mockMvc.perform(
				post("http://localhost:9001/api/v1.0/tweets/" + userName + "/like/a1331033-f4ac-496a-9092-79366d960750")
	...
	void likeTweetNotFoundTest() throws Exception {
		...
		when(usersService.getByUserName(userName)).thenReturn(null);
		MvcResult result1 = mockMvc
				.perform(post("http://localhost:9001/api/v1.0/tweets/" + userName + "/like/c20b1bc8-02cc-4586-a55a")
						.sessionAttr("userName", userName))
				.andReturn();
		String actual = result1.getResponse().getContentAsString();
		String expected = "Given tweetId cannot be found";
	...
	void replyTweetTest() throws Exception {
		...
		MvcResult result1 = mockMvc.perform(post(
				"http://localhost:9001/api/v1.0/tweets/" + userName + "/reply/a1331033-f4ac-496a-9092-79366d960750")
				.sessionAttr("userName", userName).contentType(MediaType.APPLICATION_JSON)
	...
	void replyTweetNotFoundTest() throws Exception {
		...
		when(usersService.getByUserName(userName)).thenReturn(null);
		MvcResult result1 = mockMvc
				.perform(post("http://localhost:9001/api/v1.0/tweets/" + userName + "/reply/c20b1bc8-02cc-4586-a55a")
						.sessionAttr("userName", userName).contentType(MediaType.APPLICATION_JSON)
